...
with open('./credentials.json') as f:
    ...
    ca_cert = base64.b64decode(credentials['connection']['https']['certificate']['certificate_base64'])
...
server_url = ('https' if context is not None else 'http')+'://'+host+':'+str(port)

es = Elasticsearch(
    [server_url],
    http_auth=(es_username, es_psw),
    ssl_context=context
)
