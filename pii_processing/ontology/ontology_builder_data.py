...
class OntologyBuilderData:
    ...
    default_ner_regexes = [
        ...
        ("USER_NAME", r"^[a-z0-9](@[a-z0-9!#$%&'*+\/=?^_`{|.}~-]+)", True, ()),
        (
            "DATE",
        ...
        ("TIME", r"\d{1,2}:\d{2} ?(?:[ap]\.?m\.?)?|\d[ap]\.?m\.?", False, ()),
        (
            "PHONE_NUMBER",
        ...
        ("STREET_ADDRESS", r"P\.? ?O\.? Box \d+", True, ()),
        (
            "GOVT_ID",
        ...
        ("ICD_CODE", r"[A-TV-Z][0-9][A-Z0-9](\.[A-Z0-9]{1,4})", True, ()),
    ]
    ...
    jobs = [
        ...
        "nanny",
        "healer",
        "person_who_gives_therapy",
        "armor_maker",
        "weaponsmith",
        "subordinate_official",
        "rikishi_of_lowest_rank",
        "rescuer",
        "cartoonist",
        "interior_designer",
        "couturier",
        "planner",
        "japanese_military_officer",
        "non_commissioned_officer",
        "bondman",
        "leader",
        "directress",
        "directrix",
        "agent_responsible_for_goods",
        "lord_high_steward",
        "postwoman",
        "postal_carrier",
        "lady_in_waiting",
        ...
        "actor_or_actress",
        "aviator",
        "medically_qualified_psychoanalyst",
    ...
    race_list = [
        ...
        "amerindian",
        "indigenous_peoples_of_americas",
        "amerind" "arabian_people",
        "black_people",
        "native_people",
        "indigenous_peoples",
        "autochthon",
    ...
    disease_list = [
        ...
        "hsv",
        "blennorrhoea",
        "gonorrheal_infection",
        "corpulence",
        "adiposity",
        "ringworm",
        "leper",
        "cerebral_haemorrhage",
        "suffer_paralyzing_stroke",
        "seizure",
        "phthisic",
        "abnormity",
        "disfigurement",
        ...
        "female_hysteria",
        "bowel_obstruction",
        "streptococcal_throat_infection",
        "tetanic",
        "cow_pox",
        "achromatopia",
        "dysrhythmia",
    ...
    soc_eco_class_list = [
        ...
        "warrior_class",
        "proletarian_class",
        "privileged_class" "intellectual_class",
