...
def test_en():
    ...
    for sentence in sentences:
        print(apply_regex_anonymization(sentence=sentence, lang_id="en", anonymize_condition=True))
...
def test_zh():
    ...
    for sentence in sentences:
        print(apply_regex_anonymization(sentence=sentence, lang_id="zh", anonymize_condition=True))
