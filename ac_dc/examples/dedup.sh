...
for lang in "${LANGUAGES[@]}"; do
  ...
  (time /home/jovyan/conda/envs/data/bin/python /home/jovyan/data_tooling/ac_dc/deduplicate.py build-index "cache/sharded_deduplicated_${lang}/simhash_index.pkl" "cache/sharded_deduplicated_${lang}/hashes_00001" --split "train" --threshold 2) |& tee "cache/sharded_deduplicated_${lang}/2-log.txt"
  (time LOG_LEVEL="INFO" /home/jovyan/conda/envs/data/bin/python /home/jovyan/data_tooling/ac_dc/deduplicate.py find-duplicates "cache/sharded_deduplicated_${lang}/hashes_00001" "cache/sharded_deduplicated_${lang}/simhash_index.pkl" --split "train") |& tee "cache/sharded_deduplicated_${lang}/3-log.txt"
