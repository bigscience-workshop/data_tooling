# Extracting Content from Common Crawl for 2nd Curated List of Sites

This folder gathers the scripts necessary to create the extension of the pseudo crawl dataset with the new seeds:
